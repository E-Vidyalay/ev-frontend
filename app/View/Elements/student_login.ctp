...
<nav class="tab-bar hide-for-large hide-for-xlarge hide-for-xxlarge">
    ...
    <section class="user-menu hide-for-small hide-for-medium">
      <ul>
        ...
        <li class="has-option"><a><i class="fa fa-file fa-fw"></i>ન્જીઓ</a><ul class='option-1'>
        ...
        <li class="has-option"><a><i class="fa fa-arrow-right fa-fw"></i>સાહિત્ય</a><ul class='option-1'>
