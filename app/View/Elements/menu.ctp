    ...
    <aside class="left-off-canvas-menu">
      <ul class="off-canvas-list">
        ...
        <li class="has-submenu"><a href="#"><i class="fa fa-file fa-fw"></i>ન્જીઓ</a>
            ...
            <li class='has-sub-menu'><?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-question-circle fa-fw')) . 'પ્રશ્નોત્તરી ',array('controller'=>'users','action'=>'login','?'=>array('quiz'=>'yes')),array('escape' => false));?></li>
            <li class='has-sub-menu'><?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-lightbulb-o fa-fw')) . " યોગદાન",array('controller'=>'Contributors','action'=>'index'),array('escape' => false));?></li>
        ...
        <li><?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-child fa-fw')) . " ફાયદા",array('controller'=>'pages','action'=>'benefit'),array('escape' => false)); ?></li>
          ...
          <li class='has-sub-menu'><?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-smile-o fa-fw')) . " હોબીલોબી",array('controller'=>'HobbylobbyPosts','action'=>'index'),array('escape' => false)); ?></li>
           <li class='has-sub-menu'><a><i class="fa fa-file fa-fw"></i>ન્જીઓ</a>
            ...
            <li class='has-sub-menu'><?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-info fa-fw')) . " માહિતિ મિત્ર",array('controller'=>'InformationPosts','action'=>'index'),array('escape' => false)); ?></li>
            <li><?php echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-question-circle fa-fw')) . 'પ્રશ્નોત્તરી ',array('controller'=>'users','action'=>'login','?'=>array('quiz'=>'yes')),array('escape' => false));?></li>
