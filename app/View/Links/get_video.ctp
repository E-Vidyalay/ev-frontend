...
<div id="video-file" class"large-10 columns" >
  ...
  <?php echo '<h4 align="center">'.$link['Link']['link_title'].'</h4>';
		...
		echo '<div class="video-desc"><h6>Video Description</h6><br/>'.$link['Link']['tags'].'</div></div>';}
  		...
  		echo '<div id="video-file" class"large-10 columns"><div  class="video-media show-for-large-up" style="margin-left:225px;"><h2>Content Not Available</h2></div><div class="video-desc"><h6>Video Description</h6><br/>No Description are there.</div>
</div>	';
  	}?>
  	<div id="video-file" class"large-10 columns">
			<?php if($link!=NULL){?>
