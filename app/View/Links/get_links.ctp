...
<div id="sub_cat_list" class="panel callout" style="padding:0.25rem">
	<?php echo "<a href='#' style='font-size:13px;padding:2px' class='topic_fetch' id='".$tps['Subject']['id']."/".$tps['Topic']['level_id']."'>".$tps['Subject']['name']."</a> / <a href='#' style='font-size:13px' class='sub_topic_fetch' id='".$tps['Topic']['id']."'>".$tps['Topic']['name']."</a> / <a href='#' style='font-size:13px;'>".$subTopic['SubTopic']['name']."</a>";
	 ?>
</div>
<?php
	if(count($links)>0){
